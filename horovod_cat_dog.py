...
base_dir = Path('dataset_full')

train_dir = base_dir / 'train _full'
validation_dir = base_dir / 'validation_full'
test_dir = base_dir / 'test_full'
...
callbacks = [
    ...
    hvd.callbacks.LearningRateWarmupCallback(warmup_epochs=3, initial_lr=0.001 * hvd.size(), verbose=1),
]
